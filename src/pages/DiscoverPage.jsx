...
export default function DiscoverPage({ onBack, onLogout, onViewProfile, onOpenConnect, onOpenStore, onOpenDiscover, onOpenDashboard }) {
  ...
  const [creatorTab, setCreatorTab] = useState("popular");

  const newCreators = [
    { id: 1, name: "Luna Bloom", username: "lunabloom", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80", cover: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=600&h=300&q=80", level: "star", category: "popular", specialty: "Shout Outs & Custom Videos", items: 12, rating: 4.9, followers: "24.5K" },
    { id: 2, name: "Mika Rose", username: "mikarose", avatar: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=150&q=80", cover: "https://images.unsplash.com/photo-1518609878373-06d740f60d8b?auto=format&fit=crop&w=600&h=300&q=80", level: "legend", category: "popular", specialty: "Dance & Custom Videos", items: 18, rating: 5.0, followers: "89.2K" },
    { id: 3, name: "Reina Noir", username: "reinanoir", avatar: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=150&q=80", cover: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&w=600&h=300&q=80", level: "star", category: "popular", specialty: "ASMR & Personalized Zings", items: 9, rating: 4.9, followers: "31.8K" },
    { id: 4, name: "Naomi Hart", username: "naomihart", avatar: "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?auto=format&fit=crop&w=150&q=80", cover: "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&w=600&h=300&q=80", level: "silver", category: "popular", specialty: "Custom Audio & Shout Outs", items: 6, rating: 4.6, followers: "8.3K" },
    { id: 5, name: "Kai Zenith", username: "kaizenith", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80", cover: "https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=600&h=300&q=80", level: "gold", category: "gamer", specialty: "Gaming Shout Outs & Coaching", items: 8, rating: 4.7, followers: "15.1K" },
    { id: 6, name: "Nova Pixel", username: "novapixel", avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150&q=80", cover: "https://images.unsplash.com/photo-1538481199705-c710c4e965fc?auto=format&fit=crop&w=600&h=300&q=80", level: "star", category: "gamer", specialty: "Game Reviews & Custom Videos", items: 14, rating: 4.8, followers: "42.6K" },
    { id: 7, name: "Ryu Blaze", username: "ryublaze", avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80", cover: "https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&w=600&h=300&q=80", level: "gold", category: "gamer", specialty: "Esports Commentary & Zings", items: 11, rating: 4.8, followers: "27.3K" },
    { id: 8, name: "Zara Quest", username: "zaraquest", avatar: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=150&q=80", cover: "https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?auto=format&fit=crop&w=600&h=300&q=80", level: "silver", category: "gamer", specialty: "RPG Walkthroughs & Shout Outs", items: 5, rating: 4.5, followers: "6.9K" },
  ];

  const filteredCreators = creatorTab === "all" ? newCreators : newCreators.filter((c) => c.category === creatorTab);
      ...
      <div className="flex pt-16 min-h-screen">
        ...
        <main className="flex-1 min-w-0 pb-20 md:pb-8">
          <div className="max-w-[1700px] mx-auto px-4 pt-4">
            {/* ─── Page Title ──────────────────────────────────────── */}
            <div className="mb-5">
              <h1 className="text-2xl font-bold text-[#241a22]">Discover</h1>
              ...
              <>
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button className="text-sm text-[#f472b6] font-medium hover:text-[#ec4899] transition">See All</button>
                  </div>
                  <div className="mb-4 flex gap-2">
                    {[
                      { id: "popular", label: "Popular Creators" },
                      { id: "gamer", label: "Gamer Creators" },
                    ].map((tab) => (
                      <button
                        key={tab.id}
                    ...
                    {filteredCreators.map((creator) => (
                      ...
                      >
                        <div className="relative">
                          ...
                          <span className="absolute top-2.5 right-2.5 rounded-full bg-white/90 backdrop-blur-sm px-2.5 py-0.5 text-[10px] font-semibold text-[#8c6d7f] shadow-sm">
                            {creator.followers} followers
                          </span>
                        </div>
                        <div className="p-3">
                          <div className="flex items-center gap-1.5 mb-1">
                            <span className="text-sm font-semibold text-[#241a22] truncate">{creator.name}</span>
                            <LevelBadge level={creator.level} />
                          </div>
                          <p className="text-xs text-[#b89aa8] mb-1.5">@{creator.username}</p>
                          <p className="text-sm text-[#5b4153] font-medium truncate mb-2">{creator.specialty}</p>
                          <div className="flex items-center gap-3 text-xs text-[#8c6d7f] mb-3">
                          ...
                          <button className="w-full rounded-full bg-gradient-to-r from-[#f9a8c8] to-[#f472b6] py-2 text-xs font-bold text-white tracking-wide uppercase shadow-md shadow-pink-200/50 transition hover:shadow-lg hover:from-[#f472b6] hover:to-[#ec4899] active:scale-[0.98]">
                            View Profile
                          </button>
                        </div>
                      </div>
            ...
            {/* ─── Filtered Grid (search / category active) ──────── */}
            {!showSections && (
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
