...
| Async-foundation implementation/provider review  | Engineering + Founder | 2026-08-25 | PR #9 published the transaction/privilege sub-proof, PR #10 published Node 24, and PR #11 published the provisional application-owned candidate evidence as `afdb59d` after final-head and post-merge CI. Seek separate approval before any durable local worker foundation. |
...
7. PR #8 published the provider-neutral Phase 2 async-work ADR, PR #9
   ...
   and PR #11 published the local candidate evaluation. Seek separate approval
   before any durable worker implementation. Keep Phase 2 partial; provider,
