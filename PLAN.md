...
- The founder separately approved local implementation and verification of the
  ...
  flow to async work; opening or merging a pull request remains separately
  gated.
...
7. PR #8 published the provider-neutral Phase 2 async-work ADR, PR #9
   ...
   feature branch. Review it, then seek explicit approval before opening a
   draft PR. Keep Phase 2 partial; Redis, general idempotency, providers, AWS,
   monitoring, and transactional-email choices remain open.
