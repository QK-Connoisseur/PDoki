...
7. PR #8 published the provider-neutral Phase 2 async-work ADR, PR #9
   ...
   feature branch. Review the authorized draft PR and exact-head CI before
   seeking separate merge approval. Keep Phase 2 partial; Redis, general
