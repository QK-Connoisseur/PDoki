...
export default function SignUpPage({ onLogin, onBack, onNavigateLegal }) {
  ...
  const validate = () => {
    ...
    if (!form.ageAgree) errs.ageAgree = "You must confirm your age and agree to the terms";
    return errs;
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#fff8fb] via-[#fdf0f7] to-[#fce8f3] flex flex-col">
      ...
      <div className="mx-4 mt-2 sm:mx-auto sm:max-w-md">
        <div className="flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50/80 px-4 py-3">
          ...
          <div>
            <p className="text-sm font-semibold text-amber-800">Adult Content Platform — 18+ Only</p>
            <p className="mt-0.5 text-xs leading-relaxed text-amber-700">
              Pumdoki hosts adult content. You must be 18 years of age or older to create an account. By registering, you confirm you meet this requirement.
            </p>
          </div>
        </div>
      </div>
      ...
      <main className="flex flex-1 items-start justify-center px-4 py-6 sm:px-6">
        <div className="w-full max-w-md">
          <div className="rounded-3xl border border-pink-100 bg-white/92 px-7 py-8 shadow-xl backdrop-blur-md">
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-[#241a22]">Create your account</h1>
              <p className="mt-1 text-sm text-[#9e8090]">Join Pumdoki and start your journey</p>
            </div>
              ...
              >
                <label className="flex cursor-pointer items-start gap-3">
                  ...
                  <span className="text-sm leading-relaxed text-[#5b4153]">
                    I am <strong>18 years of age or older</strong>, and I agree to the{" "}
                    <button
                      type="button"
              ...
              <button
                ...
                style={{
                  background: form.ageAgree
                    ...
                    : "#f3e0ea",
                  boxShadow: form.ageAgree ? "0 4px 20px rgba(255,77,141,0.30)" : "none",
            ...
            <p className="mt-5 text-center text-xs text-[#b89aa8]">
              ...
              <button onClick={onBack} className="font-semibold text-[#df5f97] hover:underline">
                Sign in
              </button>
            </p>
          </div>
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-xs text-[#c9aab8]">
            <button onClick={() => navLegal("terms")} className="hover:text-[#df5f97]">Terms</button>
            <span>·</span>
            <button onClick={() => navLegal("privacy")} className="hover:text-[#df5f97]">Privacy</button>
            <span>·</span>
            <button onClick={() => navLegal("cookies")} className="hover:text-[#df5f97]">Cookies</button>
            <span>·</span>
