...
import { profileData, profileMoments, profileServices, profileLongBio, profileReviews, profileSakuraLinks, profileFeedPosts, profileMedia, mediaStoreItems } from "../fixtures/profile";
    ...
    >
        <main className="flex-1 min-w-0 pb-20 md:pb-8">
          {page.status === "loading" ? (
            ...
            <ErrorState message="We couldn’t load this profile." onRetry={page.retry} />
          ) : page.status === "empty" ? (
            <EmptyState title="Nothing here yet" message="This creator hasn’t posted anything yet." />
          ) : (
            <>
              ...
              <div className="w-full max-w-[1500px] mx-auto px-6 md:px-10 lg:px-14 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-2">
                      <StaticStatusBadge status={profile.online ? 'online' : 'offline'} />
                    </div>
                ...
                <div className="flex flex-col items-start md:items-end gap-2 shrink-0">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    {/* Follow */}
                    <FollowButton username={profile.username} variant="hero" />
                      ...
                      {!selectedServiceId && (
                        <div className="p-6">
                          ...
                          <div className="flex items-center justify-between flex-wrap gap-3">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex items-center gap-1.5 bg-pink-50 text-pink-600 px-3 py-1.5 rounded-full">
                                <span className="text-sm font-bold">{totalServed}</span>
                          ...
                          <div className="mt-5 rounded-xl border border-pink-100 bg-[#fffafc] p-4">
                            <h3 className="text-sm font-bold text-[#5b4153] uppercase tracking-wide mb-3">Bio</h3>
                            <p className="text-sm text-[#4a3340] leading-loose whitespace-pre-line">{profileLongBio}</p>
                          </div>

                          {/* ── Style & Platforms card ── */}
                          <div className="mt-5 rounded-xl border border-pink-100 bg-[#fffafc] p-4">
                            <h3 className="text-sm font-bold text-[#5b4153] uppercase tracking-wide mb-3">Style &amp; Platforms</h3>
                            <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                              <div>
                                <span className="text-xs text-[#8c6d7f] font-medium">Styles</span>
                                <div className="flex flex-wrap gap-1.5 mt-1.5">
                                  {["Friendly", "Talkative", "Sweet"].map((tag) => (
                                    <span key={tag} className="inline-block bg-pink-50 text-[#8c6d7f] rounded-full px-3 py-1 text-xs font-medium border border-pink-100">{tag}</span>
                                  ))}
                                </div>
                              </div>
                              <div>
                                <span className="text-xs text-[#8c6d7f] font-medium">Platforms</span>
                                <div className="flex flex-wrap gap-1.5 mt-1.5">
                          ...
                          <div className="mt-5 rounded-xl border border-pink-100 overflow-hidden">
                            ...
                            <div className="px-4 py-3 flex items-center gap-2.5"
                              style={{ background: "linear-gradient(135deg, #fff0f6 0%, #fce7f3 50%, #fdf2f8 100%)" }}>
                              {/* Petal cluster decoration */}
                              <svg viewBox="0 0 28 28" className="w-6 h-6 shrink-0" aria-hidden="true">
                                <g transform="translate(14,14)">
                                  <ellipse cx="0" cy="-5" rx="2.8" ry="4.2" fill="#f9a8d4" opacity="0.85" transform="rotate(0)" />
                                  <ellipse cx="0" cy="-5" rx="2.8" ry="4.2" fill="#f472b6" opacity="0.75" transform="rotate(72)" />
                                  <ellipse cx="0" cy="-5" rx="2.8" ry="4.2" fill="#f9a8d4" opacity="0.85" transform="rotate(144)" />
                                  <ellipse cx="0" cy="-5" rx="2.8" ry="4.2" fill="#f472b6" opacity="0.75" transform="rotate(216)" />
                                  <ellipse cx="0" cy="-5" rx="2.8" ry="4.2" fill="#f9a8d4" opacity="0.85" transform="rotate(288)" />
                                  <circle cx="0" cy="0" r="2.5" fill="#fbbf24" />
                                  <circle cx="1" cy="-1" r="0.6" fill="#fff" opacity="0.8" />
                                </g>
                              </svg>
                              <h3 className="text-sm font-bold text-[#5b4153] uppercase tracking-wide">Sakura Links</h3>
                            </div>

                            {/* Links */}
                            <div className="bg-[#fffafc] divide-y divide-pink-50">
                              {profileSakuraLinks.length === 0 ? (
                                <p className="px-4 py-5 text-sm text-[#b89aa8] text-center">No links added yet</p>
                              ) : (
                                profileSakuraLinks.map((link) => {
                                  const platformMeta = {
                                    instagram: { color: "#e1306c", bg: "#fff0f6", icon: (
                                    ...
                                    twitter: { color: "#1a1a1a", bg: "#f9f9f9", icon: (
                                      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                      </svg>
                                    )},
                                    tiktok: { color: "#010101", bg: "#f5f5f5", icon: (
                                      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                                        <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.75a8.26 8.26 0 004.77 1.52V6.84a4.84 4.84 0 01-1-.15z" />
                                      </svg>
                                    )},
                                    youtube: { color: "#ff0000", bg: "#fff5f5", icon: (
                                      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                                        <path d="M23.495 6.205a3.007 3.007 0 00-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 00.527 6.205a31.247 31.247 0 00-.522 5.805 31.247 31.247 0 00.522 5.783 3.007 3.007 0 002.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 002.088-2.088 31.247 31.247 0 00.5-5.783 31.247 31.247 0 00-.5-5.805zM9.609 15.601V8.408l6.264 3.602z" />
                                      </svg>
                                    )},
                                    discord: { color: "#5865f2", bg: "#f0f1ff", icon: (
                                      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                                  ...
                                  const meta = platformMeta[link.platform] || { color: "#8c6d7f", bg: "#fdf2f8", icon: (
                                    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      {/* Label + handle */}
                                      <div className="flex-1 min-w-0">
                                        <p className="text-sm font-semibold text-[#241a22] leading-none">{link.label}</p>
                                        {link.handle && (
                                          <p className="mt-0.5 text-xs text-[#b89aa8] truncate">{link.handle}</p>
                                        )}
                                      </div>

                                      {/* Arrow */}
                                      <svg viewBox="0 0 24 24" className="w-4 h-4 shrink-0 text-[#d4a0b8] group-hover:text-[#f472b6] transition" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <div className="flex items-center justify-center gap-1.5 py-2"
                              ...
                              {["#fda4c4", "#f9a8d4", "#f472b6", "#f9a8d4", "#fda4c4"].map((c, i) => (
                                <svg key={i} viewBox="0 0 12 12" className="w-2.5 h-2.5" aria-hidden="true">
                                  <ellipse cx="6" cy="3" rx="2.2" ry="3.2" fill={c} opacity="0.7" transform={`rotate(${i * 36} 6 6)`} />
                                </svg>
                              ))}
                            </div>
                          </div>
                      ...
                      {selectedService && (
                        <div className="p-6">
                          ...
                          <div className="mt-6 rounded-xl border border-pink-100 bg-[#fffafc] p-4">
                            <h3 className="text-sm font-bold text-[#5b4153] uppercase tracking-wide mb-3">Service Description</h3>
                            <p className="text-sm text-[#4a3340] leading-relaxed">{selectedService.description}</p>
                          ...
                          <div className="mt-5 rounded-xl border border-pink-100 bg-[#fffafc] p-4">
                            <h3 className="text-sm font-bold text-[#5b4153] uppercase tracking-wide mb-3">Pricing and Details</h3>
                          ...
                          <div className="mt-5 rounded-xl border border-pink-100 bg-[#fffafc] p-4">
                            <div className="flex items-center justify-between mb-3">
                              <h3 className="text-sm font-bold text-[#5b4153] uppercase tracking-wide">Reviews</h3>
                              <div className="flex items-center gap-1.5">
                                <svg viewBox="0 0 20 20" className="w-4 h-4" fill="#fbbf24">
                                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                                <span className="font-bold text-[#241a22] text-sm">{selectedService.rating}</span>
                                <span className="text-[#8c6d7f] text-sm">&middot;</span>
                            ...
                            <div className="space-y-4">
                              {profileReviews
                                ...
                                .slice(0, 3)
                                .map((review) => (
                                  <div key={review.id} className="flex gap-3 pb-4 border-b border-pink-100 last:border-0">
      ...
      {previewMoment && (
        ...
        >
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden bg-black/40" style={{ aspectRatio: "3/4" }}>
              <img
                src={previewMoment.thumb}
                alt={previewMoment.name}
