      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[#9e8090]">
              Built for presence, interaction, and connection. A space where
              creators and fans grow together.
            </p>
          ...
          {/* Platform */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-[#8c6d7f]">
              Platform
            </h3>
            <ul className="mt-4 space-y-3 text-sm text-[#7f6274]">
              {["Explore Pumdoki", "About", "Blog", "Careers"].map((item) => (
                <li key={item}>
                  <a href="#" className="transition hover:text-[#df5f97]">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-[#7f6274]">
              ...
              <li>
                <button
                  onClick={() => handle("law-enforcement")}
                  className="transition hover:text-[#df5f97]"
                >
                  Law Enforcement
                </button>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <p className="text-xs text-[#b89aa8]">
            &copy; 2026 Pumdoki. All rights reserved. This site contains adult
            content and is intended for users 18 years of age or older.
          </p>
          <button
            onClick={() => handle("2257")}
