...
const HEART =
  "M8 14.5C7 13.5 1.5 10 1.5 6C1.5 3.5 3.2 1.5 5.5 1.5C6.8 1.5 7.6 2.1 8 2.9C8.4 2.1 9.2 1.5 10.5 1.5C12.8 1.5 14.5 3.5 14.5 6C14.5 10 9 13.5 8 14.5Z";
...
function StatusHeart({ status, showTooltip = true }) {
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <span className="pointer-events-none absolute bottom-full right-0 mb-1.5 whitespace-nowrap rounded-lg bg-[#241a22] px-2 py-1 text-[10px] font-semibold text-white opacity-0 transition-opacity duration-150 group-hover/sh:opacity-100 group-focus/sh:opacity-100 z-[80]">
          {label}
        </span>
      )}
    </span>
...
export default function ChatAvatar({
  ...
  return (
    ...
    >
      ...
      {showStatus && (
        <StatusHeart status={status} showTooltip={showStatusTooltip} />
      )}
    </div>
  );
}
