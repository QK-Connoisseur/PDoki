  ...
  if (active) {
    return (
      <svg viewBox="0 0 24 24" className="w-6 h-6">
        ...
        />
        <path d="M9 21V12h6v9" fill="white" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  return (
...
function ConnectIcon({ active }) {
  if (active) {
    return (
      <svg viewBox="0 0 24 24" className="w-6 h-6">
        <path d="M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2" fill="#111" stroke="#111" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="9" cy="7" r="4" fill="#111" stroke="#111" strokeWidth="1.8" />
        <path d="M22 21v-2a4 4 0 00-3-3.87" fill="none" stroke="#111" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M16 3.13a4 4 0 010 7.75" fill="none" stroke="#111" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  return (
    ...
    return (
      <svg viewBox="0 0 24 24" className="w-6 h-6">
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M3 7h18" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M16 11a4 4 0 01-8 0" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  return (
...
function CreateIcon({ active }) {
  if (active) {
    return (
      <svg viewBox="0 0 24 24" className="w-6 h-6">
        <rect x="3" y="3" width="18" height="18" rx="4" fill="#111" stroke="#111" strokeWidth="1.8" />
              ...
              <div key={item.id} className="relative" data-dropdown>
                ...
                {showComposeMenu && (
                  <div className="absolute left-0 bottom-full mb-2 w-[200px] rounded-2xl border border-pink-100 bg-white py-2 shadow-xl overflow-hidden z-50">
                    <button
                      onClick={() => { onComposePost && onComposePost(); setShowComposeMenu(false); }}
                    ...
                    <button
                      onClick={() => { onComposeMoment && onComposeMoment(); setShowComposeMenu(false); }}
                      className="flex w-full items-center gap-3 px-4 py-2.5 text-sm text-[#111] transition hover:bg-pink-50/60 hover:text-[#f9a8c8] cursor-pointer"
                    >
                      <svg viewBox="0 0 24 24" className="h-4.5 w-4.5 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
